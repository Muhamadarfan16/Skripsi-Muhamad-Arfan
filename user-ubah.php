    ...
    <div class="page-breadcrumb">
        ...
        ?>
                <div class="alert alert-success alert-dismissible bg-success text-white border-0 fade show" role="alert">
                    ...
                    </button> Berhasil Ubah Data!</strong> <a href="user.php" class="btn btn-sm btn-light text-success ml-3">lihat semua data</a>
                </div>
            <?php
            } else {
            ?>
                    ...
                    <div class="card-body">
                        ...
                        <form method="post">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" placeholder="Nama Lengkap" id="nl" name="nl" required value="<?php echo $eks->nl; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Username</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" placeholder="Username" id="un" name="un" required value="<?php echo $eks->un; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Password</label>
                                <div class="col-sm-10">
                                    <input type="password" class="form-control" placeholder="********" id="pw" name="pw">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-12">
