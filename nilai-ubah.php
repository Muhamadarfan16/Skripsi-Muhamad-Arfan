    ...
    <div class="page-breadcrumb">
        ...
        ?>
                <div class="alert alert-success alert-dismissible bg-success text-white border-0 fade show" role="alert">
                    ...
                    </button> Berhasil Ubah Data!</strong> <a href="nilai.php" class="btn btn-sm btn-light text-success ml-3">lihat semua data</a>
                </div>
            <?php
            } else {
            ?>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Ubah Data Keterangan Nilai</h4>
                        ...
                        <form method="post">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" placeholder="Keterangan Nilai" id="kt" name="kt" required value="<?php echo $eks->kt; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Jumlah Nilai</label>
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" placeholder="0" id="jm" name="jm" required value="<?php echo $eks->jm; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-12">
