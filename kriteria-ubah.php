    ...
    <div class="page-breadcrumb">
        ...
        ?>
                <div class="alert alert-success alert-dismissible bg-success text-white border-0 fade show" role="alert">
                    ...
                    </button> Berhasil Ubah Data!</strong> <a href="kriteria.php" class="btn btn-sm btn-light text-success ml-3">lihat semua data</a>
                </div>
            <?php
            } else {
            ?>
                    ...
                    <div class="card-body">
                        ...
                        <form method="post">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" placeholder="Kode Kriteria" id="kk" name="kk" required value="<?php echo $eks->kk; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Nama Kriteria</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" placeholder="Nama Kriteria" id="kt" name="kt" required value="<?php echo $eks->kt; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <div class="form-group">
                                        <select class="form-control" id="tp" name="tp">
                                            <option value='benefit' <?php echo $eks->tp == 'benefit' ? 'selected' : ''; ?>>Benefit</option>
                                            <option value='cost' <?php echo $eks->tp == 'cost' ? 'selected' : ''; ?>>Cost</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" min="0" max="100" class="form-control" placeholder="0" id="jm" name="jm" required value="<?php echo $eks->jm; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-12">
